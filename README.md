...
アップロード画像では、BOXのカード全体ではなく中央のキャラ絵だけを正方形に切り出します。属性マーク、枠、ロック、レベル、ラック表示は照合対象から外すため、同じキャラでもプレイヤーごとに異なる表示の影響を受けにくくします。
...
ログイン済みの場合、未判別アイコンに名前を確定した時点で、その切り出し画像と照合用指紋を本人専用の非公開Storageへ保存します。次回以降は過去に確定したアイコンを候補として表示します。
