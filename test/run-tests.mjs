...
import { boxGridRegions, createManualCharacter, emptyState, findCharacters, iconArtworkRegion, mergeCandidates, recognizeFromFiles, saveCandidates } from "../src/box-service.js";
